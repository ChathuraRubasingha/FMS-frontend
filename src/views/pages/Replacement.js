    ...
    <div>
      <CCard>
        <CCardBody>
          <CRow>
            <CCol xs={5}>
              <h5>Replacement of Service Registry</h5>
            </CCol>
            <CCol xs={5} sm={4} lg={5}>
            ...
            <CCol xs={2}>
              <CButton>{<CAvatar src={branch} size="md" />}Add new Service Replacement</CButton>
            </CCol>
          </CRow>
        </CCardBody>
      </CCard>
            ...
            <>
              <CCol xs={12}>
                <CTable>
                  <CTableHead>
                    <CTableRow>
                      <CTableHeaderCell scope="col">Service Replacement </CTableHeaderCell>
