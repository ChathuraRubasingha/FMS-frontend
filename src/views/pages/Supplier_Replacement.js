    ...
    <div>
      <CCard>
        <CCardBody>
          <CRow>
            <CCol xs={5}>
              <h5>Supplier of Service Replacements</h5>
            </CCol>
            <CCol xs={5} sm={4} lg={5}>
            ...
            <CCol xs={2}>
              <CButton>{<CAvatar src={branch} size="md" />}Add new Replacement </CButton>
            </CCol>
          </CRow>
        </CCardBody>
      </CCard>
            ...
            <>
              <CCol xs={12}>
                <CTable>
                  <CTableHead>
                    <CTableRow>
                      <CTableHeaderCell scope="col">Replacement</CTableHeaderCell>
...
export default Supplier_Replacement
