...
import ApprovedBookingRequests_Table from './ApprovedBookingRequests_Table'
            ...
            <CCardBody>
              <CListGroup>
                ...
                <Link to="/approvedbookingrequests" style={{ textDecoration: 'none' }}>
                  {' '}
                  <CListGroupItem active>Approved Booking Requests</CListGroupItem>
                </Link>
