...
const Fuel_vehicle = () => {
  ...
  const getProductData = async () => {
    try {
      const res = await fetch(`http://localhost:5000/api/FuelConsumption`)
    ...
    <div>
      <CCard>
        <CCardBody>
          <CRow>
            <CCol xs={6}>
              <h5>Fuel Consumption Report - Vehicle wise</h5>
            </CCol>
            <CCol xs={6} sm={4} lg={5}>
                      ...
                      .map((item) => {
                        return (
                          <CTableRow key={item.id}>
                            ...
                            <CTableDataCell>
                              <CButton href="Fuel_vehicle_form">
