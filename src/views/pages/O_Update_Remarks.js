    ...
    <div>
      <CCard>
        <CCardBody>
          <CRow>
            <CCol xs={5}>
              <h5>Odometer Update Remarks Registry</h5>
            </CCol>
            <CCol xs={5} sm={4} lg={5}>
            ...
            <CCol xs={2}>
              <CButton>{<CAvatar src={branch} size="md" />}Add new Description</CButton>
            </CCol>
          </CRow>
        </CCardBody>
      </CCard>
...
export default O_Update_Remarks
