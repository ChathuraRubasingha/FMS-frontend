    ...
    <div>
      <CCard>
        <CCardBody>
          <CRow>
            <CCol xs={5}>
              <h5>Emission Test Company Registry</h5>
            </CCol>
            <CCol xs={5} sm={4} lg={5}>
            ...
            <CCol xs={2}>
              <CButton>{<CAvatar src={branch} size="md" />}Add new Company</CButton>
            </CCol>
          </CRow>
        </CCardBody>
      </CCard>
...
export default Emission_Test_Company
