    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Vehicle Allocation Report</strong>
          </CCardHeader>
          <CCardBody>
            <CInputGroup className="mb-3">
              <CInputGroupText id="basic-addon3">Allocation Type</CInputGroupText>
              <CCard className="mb-4">
                <CCardBody>
                  <CDropdown>
                    <CDropdownToggle color="success">
                      Select the Vehicle Allocation Type{' '}
                      <CDropdownMenu>
...
export default Vehicle_Allocation
