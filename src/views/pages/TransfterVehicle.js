...
import TransfterVehicle_Table from './TransfterVehicle_Table'
import {
  CCol,
  CRow,
  CCard,
...
function TransfterVehicle() {
  return (
    <div>
      <CRow>
        <CCol sm={8} lg={8}>
          {' '}
          <TransfterVehicle_Table />
          {/* <CCardHeader>
            <CRow>
              <CCol sm={10} lg={10}>
                {' '}
          ...
          <CCard className="mb-4">
            <CCardBody>
              <CListGroup>
                ...
                <CListGroupItem component="a" href="/vehicletransfering" active>
                  Transfer Vehicle
                </CListGroupItem>
              </CListGroup>
            </CCardBody>
...
export default TransfterVehicle
