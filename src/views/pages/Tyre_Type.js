      ...
      <CCard>
        <CCardBody>
          <CRow>
            ...
            <CCol xs={2}>
              <CButton>{<CAvatar src={branch} size="md" />}Add new Tyre Type</CButton>
            </CCol>
          </CRow>
        </CCardBody>
      </CCard>
            ...
            <>
              <CCol xs={12}>
                <CTable>
                  <CTableHead>
                    <CTableRow>
                      <CTableHeaderCell scope="col">Tyre Type </CTableHeaderCell>
