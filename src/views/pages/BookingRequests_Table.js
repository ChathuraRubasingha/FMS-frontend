...
const BookingRequests_Table = () => {
  const [BookingRequests_Table_List, setBookingRequests_Table_List] = useState([])
    ...
    <div>
      <CCardHeader>
        <CCardBody>
          <CRow>
            <CCol xs={7}>
              <h5>Vehicle Booking Requests Registry</h5>
            </CCol>
            <CCol xs={3} sm={4} lg={5}>
...
export default BookingRequests_Table
